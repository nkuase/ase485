...
# Wikidata: A Collaborative Knowledge Base

---

## What is Wikidata?

Wikidata is a free, collaborative, multilingual knowledge base that can be read and edited by both humans and machines. Think of it as Wikipedia's structured data counterpart - while Wikipedia provides articles for humans to read, Wikidata provides structured data that computers can process.
